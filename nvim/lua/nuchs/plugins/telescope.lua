return {
  ...
  keys = {
    ...
    { "<Leader>f", "<Cmd>Telescope fd<CR>", desc = "Find files in cwd"},
    { "<Leader>r", "<Cmd>Telescope oldfiles<CR>", desc = "Mru files"},
    { "<Leader>g", "<Cmd>Telescope live_grep<CR>", desc = "Search in cwd"},
